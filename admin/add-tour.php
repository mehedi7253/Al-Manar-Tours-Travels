                ...
                <div class="col-md-10 mx-auto mt-4 mb-5">
                    <div class="card">
                        <div class="card-header">
                            <h3>Add New Tour <span class="float-right"><a class="btn btn-info" href="manage-tour.php">View all Tour</a></span></h3>
                        </div>
                        <div class="card-body">
                            <?php
                            if (isset($_POST['btn'])){
                                ...
                                if ($title && $description && $image){
                                    ...
                                    $sql = "INSERT INTO tour (title, description, image) VALUES ('$title', '$description', '$image')"; // insert tour  data into databse
                                    $res = mysqli_query($connect, $sql); // connect with query and database

                                    $_SESSION['success'] = 'New Tour Created Successfully';
                                }else{
                                    $_SESSION['error'] = 'Creating New Tour Failed..!!';
                                }
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" placeholder="Enter Brief Description"></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label></label>
                                    <input type="submit" name="btn" class="btn btn-success" value="Add New Tour">
                                </div>
                            </form>
                        </div>
                    </div>
