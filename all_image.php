...
//                get all image
                    if (isset($_GET['image'])){
                        ...
                        $sql_get_gallery = "SELECT * FROM sub_gallery WHERE gallery_id = '$id'"; //fetch all image from sub gallery table
                ...
                while ($row = mysqli_fetch_assoc($res_gallery)){?>
                    <div class="col-md-4 col-sm-12 float-left mt-3">
                        <div class="card" style="cursor: pointer">
                            <img src="images/<?php echo $row['image'];?>" class="card-img-top" style="height: 250px; border: 2px solid black">
                        </div>
                    </div>
                <?php }?>
            </div>
