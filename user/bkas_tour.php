                    ...
                    <div class="card">
                        <div class="card-header" style="background-color: #E3106D">
                            ...
                            if (isset($_GET['pay'])){
                                ...
                                $sql = "SELECT * FROM tour_booking, tour_invoice WHERE tour_invoice.tour_booking_id = $id";
                            ...
                            <div class="col-md-8 mx-auto">
                                <form action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  hidden name="pay_amount"  class="form-control" value="<?php echo $customer_data['price'];;?>">
                                        <input type="text" disabled  class="form-control" value="<?php echo $customer_data['price'];;?>">
                                        <input type="text" hidden name="payment_method" value="Bkash" class="form-control">
                                    </div>
                                    <div class="form-group">
