            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu bg-dark">
                        <li>
                            <?php
                            $hajj_offers = "SELECT * FROM submenu WHERE main_menu = 'hajj_offers' AND status = '0'";
                            $result_hajj = mysqli_query($connect, $hajj_offers);
                        ...
                        <li> <a class="dropdown-item text-capitalize bg-dark" href="../packages.php?package=<?php echo $hajj['id'];?>"><?php echo $hajj['menu_name'];?> &raquo</a>
                            <ul class="submenu submenu-right dropdown-menu bg-dark">
                                <?php
                                $multi_menu = "select * from multi_menu WHERE multi_menu.sub_menu_id  = '$hajj[id]'";
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu bg-dark">
                        <li>
                            <?php
                            $umrah_offers = "SELECT * FROM submenu WHERE main_menu = 'umrah_offers' AND status = '0'";
                            $result_umrah = mysqli_query($connect, $umrah_offers);
                        ...
                        echo "
                            <li class='nav-item dropdown'><a class='nav-link  dropdown-toggle' data-toggle='dropdown' href='#'> $userdata[first_name] <img src='../images/$userdata[image]' style='height: 30px; width: 30px; border-radius: 50%'></a>
                                <ul class='dropdown-menu dropdown-menu-right bg-dark'>
                                    <li><a href='dashboard.php' class='dropdown-item text-capitalize'>Profile</a></li>
                                    <li><a href='logout.php' class='dropdown-item text-capitalize'>Logout</a></li>
                                </ul>
                            </li>
                           ";
                    }
